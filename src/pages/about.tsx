...
function DirectorMessageCard({ image, name, qualification, role, message }: {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-4 sm:right-8 -translate-y-1/2 text-[#2BA84A] opacity-[0.06] pointer-events-none z-0">
        <Quote size={120} className="sm:size-[180]" />
      </div>
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="relative w-full p-4 sm:p-6 flex flex-col justify-center z-10">
          {/* Name */}
          <h3 className="text-[20px] sm:text-[28px] lg:text-[32px] font-bold text-[#0B5FA5] leading-tight mb-2">
            {name}
          </h3>

          {/* Designation */}
          <p className="text-[14px] sm:text-[18px] lg:text-[20px] font-medium text-[#4B5563] mb-3">
            {role}
          </p>

          {/* Qualifications */}
          <p className="text-[13px] sm:text-[16px] text-[#6B7280] mb-4 leading-relaxed">
            {qualification}
          </p>

          {/* Message */}
          <p className={`${textSize} leading-[1.7] text-[#4B5563] text-[13px] sm:text-[16px] lg:text-[18px]`}>
            {message}
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row h-full">
        {/* Image Section - Left */}
        <div className="relative w-full lg:w-2/5 xl:w-1/3 p-3 sm:p-6 flex items-center justify-center">
          {/* Blue-green gradient border around image */}
          <div className="absolute inset-3 rounded-[20px] bg-gradient-to-br from-[#0B5FA5]/5 to-[#2BA84A]/5" />
        ...
        <div className="relative w-full lg:w-3/5 xl:w-2/3 p-4 sm:p-6 flex flex-col justify-center z-10">
          {/* Main Quote */}
          <h3 className="text-[18px] sm:text-[20px] lg:text-[24px] font-bold text-[#0d3d5c] leading-tight mb-3">
            "If We Cannot Save the Environment, the Environment Will Not Save Us."
          </h3>

          {/* Body Messages */}
          <div className="space-y-3 text-[13px] sm:text-[15px] leading-[1.7] text-[#4B5563]">
            <p>
          ...
          <div className="mt-4 pt-3 border-t border-[#E5E7EB]">
            <h4 className="text-[20px] sm:text-[28px] lg:text-[32px] font-bold text-[#0B5FA5] leading-tight mb-2">
              Mr. Madhav Kaluskar
            </h4>
            <p className="text-[13px] sm:text-[16px] text-[#6B7280]">
              Senior Board Member
            </p>
          </div>
        </div>
  ...
  return (
    <section className="py-12 bg-white overflow-x-hidden">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        <div
          className={`mt-8 grid gap-6 max-w-3xl mx-auto ${directors.length === 1 ? "sm:grid-cols-1 justify-center" : "sm:grid-cols-2"}`}
        >
          {directors.map((d) => (
            <div
              key={d.id}
...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <section id="logo-representation" className="scroll-mt-32 py-12 lg:py-16 bg-white overflow-x-hidden">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-[24px] sm:text-[32px] lg:text-[36px] font-bold text-[#0D3D5C] mb-4 break-words">
              Logo Representation
            </h2>
            <div className="mx-auto h-1 w-20 sm:w-24 bg-gradient-to-r from-[#0D3D5C] to-[#22C55E] mb-6" />
      ...
      <section 
        id="life-at-khm" 
        className="scroll-mt-32 py-12 lg:py-16 relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="absolute top-20 left-10 w-48 h-48 sm:w-80 sm:h-80 bg-[#0B5FA5]/4 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-20 right-10 w-48 h-48 sm:w-80 sm:h-80 bg-[#2BA84A]/4 rounded-full blur-3xl pointer-events-none" />
        
        {/* Watermark gear icon */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[#0d3d5c] opacity-[0.03] pointer-events-none z-0 hidden sm:block">
        ...
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-5 relative z-10">
      ...
      <section
        id="our-vision"
        className="scroll-mt-32 border-t border-border bg-[#f8fafc] py-12 lg:py-16 overflow-x-hidden"
      >
      ...
      <section id="our-mission" className="scroll-mt-32 border-t border-border bg-white py-12 lg:py-16 overflow-x-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid items-start gap-6 sm:gap-12 lg:grid-cols-2 lg:gap-16">
            <div className="rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-card w-full">
      ...
      <section
        ...
        className="scroll-mt-36 py-12 lg:py-16 relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-64 h-64 sm:w-96 sm:h-96 bg-[#0B5FA5]/5 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 right-0 w-64 h-64 sm:w-96 sm:h-96 bg-[#2BA84A]/5 rounded-full blur-3xl pointer-events-none" />

        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full relative z-10">
          {/* Section Header */}
          <div className="mb-8 text-center">
            <h2 className="text-2xl sm:text-4xl font-bold text-[#0d3d5c] font-display leading-tight">
              Director's Message
            </h2>
      ...
      >
        ...
        {/* Soft blue-green radial gradients */}
        <div className="absolute top-0 right-0 w-64 h-64 sm:w-96 sm:h-96 bg-[#0B5FA5]/5 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-64 h-64 sm:w-96 sm:h-96 bg-[#2BA84A]/5 rounded-full blur-3xl pointer-events-none" />

        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-4 w-full relative z-10">
          {/* Section Header */}
