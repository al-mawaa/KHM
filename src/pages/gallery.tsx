...
export default function GalleryPage() {
  ...
  const items = galleryItems.filter((item) => item.category.toLowerCase() === activeSection);
      ...
      <section className="py-12 lg:py-16">
        ...
        <div className="mx-auto max-w-[1400px] px-4 lg:px-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-12 text-slate-500">No gallery images found</div>
