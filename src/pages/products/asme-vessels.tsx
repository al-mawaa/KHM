...
import { ASME_VESSELS } from "@/lib/products/asme-vessels";

export default function AsmeVesselsPage() {
  const { heroImages, valueImages, detailBlocks, faqs } = ASME_VESSELS;
    ...
    <main className="bg-white text-gray-800">
      ...
      <div className="border-b border-gray-200 bg-[#f4f6f8]">
        <div className="mx-auto flex max-w-[1400px] items-center gap-2 px-4 py-3 text-xs font-medium uppercase tracking-wide text-gray-600 lg:px-6">
          ...
          <ChevronRight className="h-3.5 w-3.5 opacity-50" aria-hidden />
          <span className="text-[#1a5276]">ASME Vessels</span>
        </div>
      </div>
      ...
      <section className="py-12 lg:py-16">
        <div className="mx-auto max-w-[1400px] px-4 lg:px-6">
          ...
          >
            <img
              src={heroImages.main}
              alt="ASME vessels — industrial facility"
            ...
            <div className="flex flex-col gap-3">
              {heroImages.secondary.map((src, i) => (
                <img
                  key={src}
                  src={src}
                  alt={i === 0 ? "Pressure vessel fabrication" : "ASME vessel installation"}
          ...
          >
            ...
            <p className="mt-6 text-sm leading-relaxed text-gray-600 sm:text-base">{ASME_VESSELS.intro}</p>
          ...
          >
            {valueImages.map((src, i) => (
              <div key={src} className="product-img-pair-cell shadow-lg">
                <img
                  src={src}
                  alt={i === 0 ? "Horizontal ASME pressure vessel" : "Industrial ASME vessel"}
      ...
      <section className="bg-[#1a5276] py-12 text-center text-white lg:py-14">
        <div className="mx-auto max-w-[900px] px-4 lg:px-6">
          ...
          <p className="mt-4 text-sm leading-relaxed text-white/90 sm:text-base">
            Stop worrying about how to find the right water treatment plant for your business. We are here to help you.
          </p>
          <Link
            to="/contact"
